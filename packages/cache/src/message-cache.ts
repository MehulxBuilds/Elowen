...
let userMessageCacheInstance: UserMessageCache | null = null;
export function getUserMessageCache(): UserMessageCache {
    if (!userMessageCacheInstance) {
        userMessageCacheInstance = new UserMessageCache();
    }
    return userMessageCacheInstance;
}